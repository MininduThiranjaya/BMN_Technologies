import { ChevronLeft, ChevronRight, Quote, Star, ChevronRightCircleIcon} from "lucide-react";
...
function AboutUs() {
    ...
    const testimonialData = [
        {
            ...
            testimonial: "This platform made our workflow so much smoother and saved countless hours!",
            rating: 5
        },
        {
            name: "Rahul Mehta",
            ...
            testimonial: "An absolute game-changer. The user-friendly design impressed our whole team.",
            rating: 4
        },
        {
            name: "Sophia Williams",
            position: "UI/UX Designer",
            company: "CreativePixels Studio",
            testimonial: "I loved how intuitive everything was. It really makes collaboration effortless.",
            rating: 3
        },
        {
            name: "David Chen",
            ...
            testimonial: "The insights we were able to extract using this tool were simply incredible.",
            rating: 2
        },
        {
            ...
            testimonial: "Our campaigns have seen measurable improvements since adopting this solution.",
            rating: 1
        }
    ];
    ...
    return (
        <div className="flex flex-col md:flex-row w-full h-screen pt-16 md:pt-10">
            <div className="w-full md:w-1/2 h-1/2 md:h-full flex-row items-center justify-center text-white gap-4">{/*bg-color*/}   
                <div className="flex w-full h-1/6 items-center justify-center">{/*bg-color*/}
                ...
                <div className="h-5/6 w-full text-black p-5">{/*bg-color*/}
                    <p
                        className="text-sm md:text-lg mb-4 text-center"
                    >
                        At BMN-Texhnologies, we're passionate about creating a sustainable future through innovative
                        solar energy solutions. Our team of experts combines cutting-edge technology
                        with personalized service to deliver exceptional results for homes and businesses.
                    </p>
            ...
            <div className="w-full md:w-1/2 h-1/2 md:h-full flex-row items-center justify-center text-white gap-4">{/*bg-color*/}
                ...
                <div className="relative flex w-full h-5/6 md:h-5/6 items-start justify-center">{/*bg-color*/}
                    <div className="flex flex-col items-center justify-center">
                        {/* Carousel Content */}
                        <div className="max-w-72 w-full h-48 md:max-w-md md:w-full md:h-56">
                            {/* Carousel Navigation */}
                            <button
                            ...
                            >
                                <ChevronLeft size={24} className="text-blue-500 shrink-0 sm:w-6 sm:h-6 w-5 h-5" />
                            </button>
                            ...
                            >
                                <ChevronRight size={24} className="text-blue-500 shrink-0 sm:w-6 sm:h-6 w-5 h-5" />
                            </button>
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    {!loading && testimonialData.length > 0 ? (
                                        <>
                                            <div>
                                                <Quote size={32} className="text-blue-500 mb-0 md:mb-2 shrink-0 w-7 h-7 md:w-8 md:h-8" />
                                        ...
                                        <>
                                            ...
                                            <div className="flex items-center justify-between mt-4">
                                                <div>
                                                    <p className="font-bold text-lg text-black">No Comments....</p>
                                                </div>
                                            </div>
                                        </>
                                    )}
                        ...
                        <div className="flex justify-center mt-4 md:mt-8">
                            {testimonialData.map((_, index) => (
                                <button
                                    key={index}
                                    className={`w-2 h-2 mx-1 rounded-full transition-all md:w-3 md:h-3 md:mx-1 md:rounded-full md:transition-all ${activeIndex === index ? "bg-blue-500 w-4 md:w-6" : "bg-gray-300"
                                        }`}
                                    onClick={() => {
                                        setIsAutoPlaying(false);

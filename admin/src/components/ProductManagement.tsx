...
import { Edit2, Trash2, Package, ChevronLeft, ChevronRight} from 'lucide-react';
...
const ProductManagement = ({ products, deleteProduct, onSuccess }: ProductDetailsProps) => {
  ...
  const confirmDelete = () => {
    ...
    async function fetchAllProducts() {
      await axios.delete(endpoints.product.deleteProduct.replace(":productId", deleteConfirmation.id ?? ""),{ 
        headers: {
        ...
        {currentProducts.length > 0 && currentProducts.map((product) => (
          ...
          >
            ...
            <div className="relative h-48 bg-gray-100">
              ...
              <div
                className={`${product.imageUrl ? 'hidden' : 'flex'} absolute inset-0 items-center justify-center bg-gray-100`}
              >
